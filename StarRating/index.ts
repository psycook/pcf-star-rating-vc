...
import { StarRating as StarRatingComponent, IStarRatingProps } from "./StarRatingComponent";
...
export class StarRating implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
        ...
        const readOnly = context.parameters.readOnly?.raw ?? false;
        ...
        return React.createElement(StarRatingComponent, props);
    }
